...
ADD_PRICE_KEY = "price_value,product_id,time_unix,has_discount,discount_price"
...
CREATE_PRICE_TABLE_QUERY = """CREATE TABLE IF NOT EXISTS price (id INTEGER PRIMARY KEY, price_value REAL NOT NULL, product_id INTEGER NOT NULL, time_unix REAL NOT NULL, has_discount INTEGER, discount_price REAL);"""